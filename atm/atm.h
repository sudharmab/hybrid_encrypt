...
typedef struct _ATM
{
    ...
    EVP_PKEY* private_key;       // Use EVP_PKEY for private key
    EVP_PKEY* bank_public_key;   // Use EVP_PKEY for public key
    unsigned char aes_key[32];
    int session_active;          // Stores our user during session
    char session_user[251];      // Track user when logged
} ATM;
