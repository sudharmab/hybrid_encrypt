...
You will make use of OpenSSL like you did in Project 3. You'll
need to add
...
the design document. For the document to receive full points, it must be a
complete description of your system and contain **5 distinct vulnerabilities**
...
For each additional distinct attack you identify and defend against, you can
get up to **1%** extra credit added to your overall grade, up to a maximum of
**3%**.  Also, the more attacks you prevent, the greater your chances of
surviving the break-it phase of the project.

If your design document does not correspond to your implementation,
you will be given no credit for that particular attack---if you are not able to
implement some feature that you think should be present, feel free to describe
it so long as you state clearly that it is not implemented; for well-described
attacks and designs without implementation, partial credit will be available.

### Rubric

Part 1 (Build-it) is worth 80% of the overall project grade, broken down as follows:

The 24 automated functionality tests will be worth 1.25% each, for a total of 30%.

The other 50% will be based on your design document, which comprises 16 total pieces:
 * 5%: Design description for the system
 * 45%: Vulnerabilities (x5)
    * 3%: Vulnerability identified
    * 3%: Mitigation described (e.g., "To protect against X, we could do...")
    * 3%: Mitigation implemented (your code actually does what you described)
